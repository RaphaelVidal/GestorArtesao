              ...
              <CardGroup>
                ...
                <Card className="text-white bg-primary py-5 d-md-down-none" style={{ width: '44%' }}>
                  <CardBody className="text-center">
                    <div>
                      <h2>Bem vindo!</h2>
                      <p className="text-justify">O gestor Artesão tem como objetivo auxiliar o artsão no gerenciamento de materiais, produtos e vendas.</p>
                      {/* <Link to="/register">
                        <Button color="primary" className="mt-3" active tabIndex={-1}>Cadastrar agora!</Button>
                      </Link> */}
                      <h5>suporte técnico: gestor.artesao@gmail.com</h5>
                    </div>
                  </CardBody>
                </Card>
              </CardGroup>
